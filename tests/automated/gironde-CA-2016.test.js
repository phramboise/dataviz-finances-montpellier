...
const docBudg2016 = docBudgs.find(db => db['Exer'] === 2017);
...
test.skip(`Pour le CA 2016 de la Gironde, RI-EM-1 devrait représenter ~57,8 millions d'euros`, () => {
    const df1 = hierAgg2016Elements.find(e => e.id === 'RI-EM-1')

    expect(df1.total/MILLION).toBeCloseTo(57800000/MILLION, 1);
});

test.skip(`Pour le CA 2016 de la Gironde, RI-1 devrait représenter ~19,6 millions d'euros`, () => {
    const df1 = hierAgg2016Elements.find(e => e.id === 'RI-1')

    expect(df1.total/MILLION).toBeCloseTo(19600000/MILLION, 1);
});

test.skip(`Pour le CA 2016 de la Gironde, RI devrait représenter ~107,3 millions d'euros`, () => {
...
test.skip(`Pour le CA 2016 de la Gironde, DI-2-4 devrait représenter ~10,6 millions d'euros`, () => {
    const df1 = hierAgg2016Elements.find(e => e.id === 'DI-2-4')

    expect(df1.total/MILLION).toBeCloseTo(10600000/MILLION, 1);
});

test.skip(`Pour le CA 2016 de la Gironde, DI-EM-1 devrait représenter ~37,9 millions d'euros`, () => {
    const df1 = hierAgg2016Elements.find(e => e.id === 'DI-EM-1')

    expect(df1.total/MILLION).toBeCloseTo(37900000/MILLION, 1);
});

test.skip(`Pour le CA 2016 de la Gironde, DI devrait représenter ~244,9 millions d'euros`, () => {
...
test.skip(`Pour le CA 2016 de la Gironde, RF-5-1 devrait représenter ~150,1 millions d'euros`, () => {
    const df1 = hierAgg2016Elements.find(e => e.id === 'RF-5-1')

    expect(df1.total/MILLION).toBeCloseTo(150100000/MILLION, 1);
});

test.skip(`Pour le CA 2016 de la Gironde, RF-1-1 devrait représenter ~325,1 millions d'euros`, () => {
    const df1 = hierAgg2016Elements.find(e => e.id === 'RF-1-1')

    expect(df1.total/MILLION).toBeCloseTo(325100000/MILLION, 1);
});

test.skip(`Pour le CA 2016 de la Gironde, RF devrait représenter ~1527,4 millions d'euros`, () => {
...
test.skip(`Pour le CA 2016 de la Gironde, DF devrait représenter ~1375,6 millions d'euros`, () => {
...
test.skip(`Pour le CA 2016 de la Gironde, D devrait représenter ~1620,5 millions d'euros`, () => {
    const df = hierAgg2016Elements.find(e => e.id === EXPENDITURES);

    expect(df.total/MILLION).toBeCloseTo(1620500000/MILLION, 1);
});

test.skip(`Pour le CA 2016 de la Gironde, R devrait représenter ~1634,8 millions d'euros`, () => {
...
test.skip('Pour le CA 2016 de la Gironde, la ligne DF R51 A65111 est présente dans DF-1-1-3 à 75% et DF-1-5 à 25%', () => {
...
test.skip('Pour le CA 2016 de la Gironde, la ligne DF R51 A65111 est présente dans DF-2-4', () => {
